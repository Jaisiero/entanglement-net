...
const COMPACT_SIZE: usize = core::mem::size_of::<EntityMoveCompact>(); // 36 (was 32 before source_shard_hash u32 was appended)

// ── golden file format ────────────────────────────────────────────────
const MAGIC: u32 = 0x474F_4C44; // "GOLD"
// Bumped to 3 when EntityMoveCompact grew from 32 to 36 bytes
// (source_shard_hash u32 appended). Old golden file is auto-deleted
// + regenerated by the test on first run after the version mismatch
// fires.
const VERSION: u32 = 3;
